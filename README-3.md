...
**Vonhathoang-Tools** is a modified, portable fork maintained by **vonhathoang**, designed to handle everything from **Discord automation** and **OSINT reconnaissance** to **network diagnostics**, **cryptography utilities**, and **Roblox lookups** — all from a single terminal interface. It works natively on **Windows, Linux & Termux**, requires no external setup beyond Python, and is **regularly updated** with new features and improvements.
...
<div align="center">
  <p>Modified with <3 by <b>vonhathoang</b></p>
</div>

## 🌐 Language support

The portable build defaults to **Vietnamese** and includes:
Vietnamese, Chinese, Korean, Japanese, English, Spanish, French, Portuguese,
Argentine Spanish, and Filipino.

Use `L`, `lang`, or `language` from the main menu to switch languages.
...
`tkintermapview` is optional because Tk GUI support is commonly unavailable in Termux.


## 🛡️ Portable build notes

This fork keeps the original license notice and identifies the modification as **vonhathoang**.
For a safer portable distribution, the launcher disables legacy modules intended for credential
collection, destructive bulk actions, or password cracking. Defensive/diagnostic utilities remain available.
