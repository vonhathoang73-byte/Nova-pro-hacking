...
user = os.environ.get('USERNAME', 'buoi') if os.name == 'nt' else os.environ.get('USER', 'vonhathoang')
def get_config():
    try:
...
try:
    ...
    print("Vui lòng cài pystyle: pip install pystyle")
    sys.exit(1)
...
def init_os():
    ...
    if cols < 80:
        cl = Theme.get_colors()
        print(Colorate.Horizontal(cl.get("num", ""), f"\n  [!] CẢNH BÁO: Chiều rộng terminal là {cols} (nhỏ hơn 80)."))
        print(Colorate.Horizontal(cl.get("txt", ""), "      Để có trải nghiệm tốt nhất và căn chỉnh hợp lý, vui lòng mở rộng cửa sổ terminal!\n"))
        time.sleep(3.0)
...
9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP
 9XXXXXXXXXXXXXXXXXXXVXXXXXXXXOo.           .oOXXXXXXXXVXXXXXXXXXXXXXXXXXXXP
  `9XXXXXXXXXXXXXXXXXXXXX'~   ~`OOO8b   d8OOO'~   ~`XXXXXXXXXXXXXXXXXXXXXP'
    `9XXXXXXXXXXXP' `9XX'   DEV    `98v8P'  HOANG   `XXP' `9XXXXXXXXXXXP'
        ~~~~~~~       9X.          .db|db.          .XP       ~~~~~~~
                        )b.  .dbo.dP'`v'`9b.odb.  .dX(
                      ,dXXXXXXXXXXXb     dXXXXXXXXXXXb.
                     dXVÕXXNHẬTXXP'   .   `9XXXXXHOÀNGXb
  ...
  __________________________________________________________________________
    ...
    print("\n")
    user = os.environ.get('USERNAME', 'Unkown') if os.name == 'nt' else os.environ.get('USER', 'vonhathoang')
    seq = [
        f"Đang khởi động Copeland OS [ Node: {user} ]...",
        "CÔNG CỤ BỞI VONHATHOANG...",
        "tiktok:@hoangem8158..."
    ]
    for s in seq:
        type_print(s, 0.02)
